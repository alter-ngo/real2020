  ...
  render() {
    ...
    return (
      ...
      <br/>
        ...
        <Form.Item validateStatus={valid[2].status} help={valid[2].txt} label={<p style={{fontSize:18,fontWeight:500}}> În ce județ predați?</p>}>
          <Select
            showSearch
            style={{ width: 240 }}
        ...
        <Form.Item validateStatus={valid[3].status} help={valid[3].txt} label={<p style={{fontSize:18,fontWeight:500}}> În ce localitate predați?</p>}>
          <Select
            showSearch
            style={{ width: 240 }}
        ...
        <Form.Item validateStatus={valid[4].status} help={valid[4].txt} label={<p style={{fontSize:18,fontWeight:500}}> La ce liceu predați?</p>}>
          <Select
            showSearch
            style={{ width: 240 }}
