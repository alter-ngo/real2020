        ...
        <div className="gx-d-flex justify-content-center">
            <Widget>
              <Form layout={"vertical"}>
                <Form.Item validateStatus={valid[0].status} help={valid[0].txt} label={<span>Ai acces la activități extracurriculare în afara liceului, care să fie promovate în cadrul liceului?&nbsp;       
                ...
                <Form.Item validateStatus={valid[1].status} help={valid[1].txt} label={<span>Ai acces la activități extracurriculare organizate în cadrul liceului?&nbsp;       
                ...
                <Form.Item validateStatus={valid[2].status} help={valid[2].txt} label={<span>Ai acces la susținere suplimentară pentru cultivarea performanțelor academice?&nbsp;       
                ...
                <Form.Item validateStatus={valid[3].status} help={valid[3].txt} label={<span>Ce părere ai despre nivelul dotărilor?&nbsp;       
                ...
                <Form.Item validateStatus={valid[4].status} help={valid[4].txt} label={<span>Ce părere ai despre starea dotărilor?&nbsp;       
                ...
                <Form.Item validateStatus={valid[5].status} help={valid[5].txt} label={<span>Cât de curat consideri că este liceul?&nbsp;       
                ...
                <Form.Item validateStatus={valid[25].status} help={valid[25].txt} label={<span>Ți s-a solicitat vreodată să contribui la fondul clasei?&nbsp;       
                <Tooltip title="Fondul clasei presupune strângerea banilor pentru achiziționarea unor resurse / bunuri pentru uz comun.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                  <Radio.Group onChange={this.handleChange(25)} value={question[25].value}>
                    {radioOpts}
                  </Radio.Group>
                </Form.Item>
                <Form.Item validateStatus={valid[6].status} help={valid[6].txt} label={" Câte sesiuni de meditații ai pe săptămână?"}>
                  <TextArea value={question[6].value} onChange={this.handleChange(6)} autosize={{ minRows: 1, maxRows: 1 }} />
                </Form.Item>
                <Form.Item validateStatus={valid[7].status} help={valid[7].txt} label={<span>Cât de satisfăcut ești de relația elev-profesor?&nbsp;       
                ...
                <Form.Item validateStatus={valid[8].status} help={valid[8].txt} label={<span>Cât de satisfăcut ești de relația elev-diriginte?&nbsp;       
                ...
                <Form.Item validateStatus={valid[9].status} help={valid[9].txt} label={<span>Cât de interactive sunt orele de curs?&nbsp;       
                ...
                <Form.Item validateStatus={valid[10].status} help={valid[10].txt} label={<span>Cât de implicați consideri că sunt profesorii pe parcursul orei de curs?&nbsp;       
                ...
                <Form.Item validateStatus={valid[11].status} help={valid[11].txt} label={<span>Cât de des consideri că profesorii utilizează dotările?&nbsp;       
                ...
                <Form.Item validateStatus={valid[12].status} help={valid[12].txt} label={<span>Cât de mult consideri că profesorii pun accentul pe efort în afara orelor?&nbsp;       
                ...
                <Form.Item validateStatus={valid[14].status} help={valid[14].txt} label={<span>Cât de mult te inspiră profesorii tăi?&nbsp;       
                ...
                <Form.Item validateStatus={valid[26].status} help={valid[26].txt} label={<span>Ai apelat la serviciile consilierilor scolari?&nbsp;       
                <Tooltip title="Conșiierii școlari pot ajuta prin susținere în decizii personale și profesionale.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                  <Radio.Group onChange={this.handleChange(26)} value={question[26].value}>
                    {radioOpts}
                  </Radio.Group>
                </Form.Item>
                <Form.Item validateStatus={valid[15].status} help={valid[15].txt} label={<span>Cât de mult te-au ajutat consilierii școlari?&nbsp;       
                <Tooltip title="Conșiierii școlari pot ajuta prin susținere în decizii personale și profesionale.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                <IconSlider marks={marks} min={1} max={10} value={question[15].value} onChange={(value) => { this.handleSChange(value, 15) }} />
                </Form.Item>
                <Form.Item validateStatus={valid[27].status} help={valid[27].txt} label={<span>Ai fost vreodată hărțuit de un profesor?&nbsp;       
                <Tooltip title="Prin hărțuire facem referire la violență fizică sau verbală, avansuri nepotrivite etc.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                  <Radio.Group onChange={this.handleChange(27)} value={question[27].value}>
                    {radioOpts}
                  </Radio.Group>
                </Form.Item>
                <Form.Item validateStatus={valid[16].status} help={valid[16].txt} label={<span>Cât de relaxat te simți la liceu?&nbsp;       
                <Tooltip title="Prin gradul de relaxare ne referim la relațiile cu colegii și cu profesorii, la nivelul de stres etc.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                <IconSlider marks={marks} min={1} max={10} value={question[16].value} onChange={(value) => { this.handleSChange(value, 16) }} />
                </Form.Item>
                <Form.Item validateStatus={valid[17].status} help={valid[17].txt} label={<span>Care sunt cele mai semnificative surse de stres resimțite de tine?&nbsp;       
                <Tooltip title="Povestește-ne de sursele care îți generează stres cel mai des.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                  <TextArea value={question[17].value} onChange={this.handleChange(17)} autosize={{ minRows: 1, maxRows: 1 }} />
                </Form.Item>
                <Form.Item validateStatus={valid[18].status} help={valid[18].txt} label={<span>Cât de divers ți se pare colectivul liceului tău?&nbsp;       
                ...
                <Form.Item validateStatus={valid[19].status} help={valid[19].txt} label={" Cât de ușor ți-a fost să te integrezi în colectiv?"}>
                <IconSlider marks={marks} min={1} max={10} value={question[19].value} onChange={(value) => { this.handleSChange(value, 19) }} />
                </Form.Item>
                <Form.Item validateStatus={valid[20].status} help={valid[20].txt} label={<span>Cât de competitivi consideri că sunt colegii tăi?&nbsp;       
                <Tooltip title="Prin competitivitate ne referim la competiția pe note dintre colegi sau alte asemenea.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                <IconSlider marks={marks} min={1} max={10} value={question[20].value} onChange={(value) => { this.handleSChange(value, 20) }} />
                </Form.Item>
                <Form.Item validateStatus={valid[28].status} help={valid[28].txt} label={<span>Ai fost vreodată hărțuit de colegi?&nbsp;       
                <Tooltip title="Prin hărțuire ne referim la violență fizică sau verbală, avansuri nepotrivite etc.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                  <Radio.Group onChange={this.handleChange(28)} value={question[28].value}>
                    {radioOpts}
                  </Radio.Group>
                </Form.Item>
                <Form.Item validateStatus={valid[21].status} help={valid[21].txt} label={" Ce sfaturi i-ai da unui viitor elev în liceul tău?"}>
                  <TextArea value={question[21].value} onChange={this.handleChange(21)} autosize={{ minRows: 2, maxRows: 5 }} />
                </Form.Item>
                <Form.Item validateStatus={valid[22].status} help={valid[22].txt} label={" Ce sfaturi le-ai da profesorilor tăi?"}>
                  <TextArea value={question[22].value} onChange={this.handleChange(22)} autosize={{ minRows: 2, maxRows: 5 }} />
                </Form.Item>
                <Form.Item validateStatus={valid[23].status} help={valid[23].txt} label={" Ce recomandări ai propune conducerii liceului în care înveți?"}>
                  <TextArea value={question[23].value} onChange={this.handleChange(23)} autosize={{ minRows: 2, maxRows: 5 }} />
                </Form.Item>
                <Form.Item validateStatus={valid[24].status} help={valid[24].txt} label={<span>Ce recomandări ai propune factorilor decizionali?&nbsp;       
                <Tooltip title="Factorii decizionali includ: Guvernul, Ministerul Educației Naționale etc.">
                  <Icon type="question-circle-o" />
                </Tooltip></span>}>
                  <TextArea value={question[24].value} onChange={this.handleChange(24)} autosize={{ minRows: 2, maxRows: 5 }} />
                </Form.Item>
              </Form>
