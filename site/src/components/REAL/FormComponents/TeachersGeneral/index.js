  ...
  render() {
    ...
    return (
      ...
      <br/>
        ...
        <Form.Item validateStatus={valid[2].status} help={valid[2].txt} label={" În ce județ predați?"}>
          <Select
            showSearch
            style={{ width: 200 }}
        ...
        <Form.Item validateStatus={valid[3].status} help={valid[3].txt} label={" În ce localitate predați?"}>
          <Select
            showSearch
            style={{ width: 200 }}
        ...
        <Form.Item validateStatus={valid[4].status} help={valid[4].txt} label={" La ce liceu predați?"}>
          <Select
            showSearch
            style={{ width: 200 }}
