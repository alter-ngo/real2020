...
class StudentsOpinionForm extends React.Component {
  ...
  render() {
    ...
    let { question, radioOptions, radioValue,teachOpts,selectedEvMeth,timeIntervals } = this.state;
    const radioStyle = {
      display: 'block',
      height: '30px',
      lineHeight: '30px',
          ...
          <Col span={24}>
            <Widget>
              <Form layout={"vertical"}>
                ...
                <Form.Item label={<span>Cat de mult va implicati in organizarea de activități extracurriculare interne?&nbsp;       
                ...
                <Form.Item label={<span>Cat de des va implicati in susținere suplimentară pentru cultivarea performanțelor academice?&nbsp;       
                ...
                <Form.Item label={<span>Considerați că beneficiați de oportunități de dezvoltare profesională?&nbsp;       
                ...
                <Form.Item label={<span>Ce părere aveti despre nivelul dotărilor?&nbsp;       
                ...
                <Form.Item label={<span>Ce părere aveti despre starea dotărilor?&nbsp;       
                ...
                <Form.Item label={<span>Cât de curat considerati că este liceul?&nbsp;       
                ...
                <Form.Item label={<span>Cât de divers este colectivul profesoral?&nbsp;       
                ...
                <Form.Item label={" Cât de ușor v-a fost să vă integrați în colectivul profesoral?"}>
                <IconSlider marks={marks} min={1} max={10} value={question[8].value} onChange={(value) => { this.handleSChange(value, 8) }} /></Form.Item>
                <Form.Item label={<span>Cât de satisfăcut sunteți de relația profesor-conducere?&nbsp;       
                ...
                <Form.Item label={<span>Cât de interactive sunt orele dumneavoastra de curs?&nbsp;       
                ...
                <Form.Item label={<span>Cât de des vă evaluați elevii?&nbsp;       
                ...
                <Form.Item label={" Care sunt metodele de evaluare folosite de dumneavoastră?"}>
                ...
                <Form.Item label={<span>Cât de mult puneți accentul pe scoaterea in evidenta a unor anumite persoane?&nbsp;       
                ...
                <Form.Item label={<span>Ați fost vreodată hărțuit de către un cadru didactic?&nbsp;       
                ...
                <Form.Item label={<span>Cât de dedicați considerați că sunt elevii dumneavoastră în privința materiei pe care o predați?&nbsp;       
                ...
                <Form.Item label={<span>Cât de implicați considerați că sunt elevii dumneavoastră în cadrul orelor de curs?&nbsp;       
