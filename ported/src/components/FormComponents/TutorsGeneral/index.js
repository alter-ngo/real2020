...
class GeneralForm extends React.Component {
	...
	render() {
		const { valid, question,verif } = this.state;
		let judete = [],
			litere = [];
		for (let i = 0; i <= 41; i++) {
				...
				<Form layout={"vertical"}>
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								În ce județ învață copilul dumneavoastră?
							</p>
						}
					>
						<Select
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								În ce localitate învață copilul dumneavoastră?
							</p>
						}
					>
						<Select
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								La ce liceu învață copilul dumneavoastră?
							</p>
						}
					>
						<Select
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								În ce clasă este copilul dumneavoastră?
							</p>
						}
					>
						<Radio.Group
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								Care este litera clasei copilului dumneavoastră?
							</p>
						}
					>
<TextArea
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								La ce filieră este copilul dumneavoastra?
							</p>
						}
					>
						<Select
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								La ce profil învata copilul dumneavoastra?
							</p>
						}
					>
						<Select
					...
					<Form.Item
						...
						label={
							<p style={{ fontSize: 18, fontWeight: 500 }}>
								{" "}
								Care este specializarea copilului dumneavoastră?
							</p>
						}
					>
						<Select
